...
cart.forEach((cartItem) => {
    ...
    // If matchingProduct is not found, skip this item
...
document.querySelector('.js-order-summary').innerHTML = cartSammaryHtml;
...
document.querySelectorAll('.js-delivery-option').forEach((element) => {
    element.addEventListener('click', () => {
        ...
        renderOrderSummary();// model > view mvc technic
    });
});
}
